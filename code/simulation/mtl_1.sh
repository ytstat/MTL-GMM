...
#SBATCH --job-name=mtl_1     # The job name.
...
R CMD BATCH --no-save --vanilla mtl_1.R /burg/home/yt2661/projects/MTL-GMM/experiments/mtl_1/out/${SLURM_ARRAY_JOB_ID}_${SLURM_ARRAY_TASK_ID}.txt

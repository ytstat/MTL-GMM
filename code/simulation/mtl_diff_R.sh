...
#SBATCH --job-name=mtl_diff_R     # The job name.
...
R CMD BATCH --no-save --vanilla mtl_diff_R.R /burg/home/yt2661/projects/MTL-GMM/experiments/mtl_diff_R/out/${SLURM_ARRAY_JOB_ID}_${SLURM_ARRAY_TASK_ID}.txt

...
#SBATCH --job-name=mtl_epsilon     # The job name.
...
R CMD BATCH --no-save --vanilla mtl_epsilon.R /burg/home/yt2661/projects/MTL-GMM/experiments/mtl_epsilon/out/${SLURM_ARRAY_JOB_ID}_${SLURM_ARRAY_TASK_ID}.txt
